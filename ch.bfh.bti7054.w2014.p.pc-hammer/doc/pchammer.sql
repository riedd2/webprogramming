...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2015 at 09:15 PM
...
--
ALTER TABLE `user`
 ADD PRIMARY KEY (`id_user`), ADD UNIQUE KEY `username_key` (`username`);
...
--
ALTER TABLE `orderposition`
MODIFY `id_orderposition` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=202;
--
